        ...
        <main className="bg-hero-login bg-center bg-cover bg-no-repeat flex items-center justify-center h-screen w-full bg-opacity-20">
            <div className="bg-white shadow px-6 py-6 rounded">
                ...
                <form className="flex flex-col">
                    <input type="text" className="focus:outline-none border border-gray-300 px-6 py-2 rounded w-72 mt-4" placeholder="Nombre"/>

                    <input type="text" className="focus:outline-none border border-gray-300 px-6 py-2 rounded w-72 mt-4" placeholder="Apellidos"/>
                ...
                <div className="mt-4 flex flex-col justify-center items-center">
                    <p className="text-sm text-primary-500 font-medium">Ya tienes cuenta,</p>
                    <a href="#" className="text-sm text-gray-500 font-semibold">Inicia Sesión</a>
                </div>
            </div>
        </main>
    );
